...
all_climate_data = climate_data %>% rename(normal_ppt = norm_ppt,
                                                         ...
                                                         no_change_seasonal_ppt = seasonal_ppt)

saveRDS(all_climate_data, file = "~/gitRepos/code_climate/all_climate_data_province.RDS")


filtered_climate_data = climate_data %>% filter(yr >= 2020 & yr <= 39)
filtered_climate_data = filtered_climate_data %>% rename(normal_ppt = norm_ppt,
                                                         drier_ppt = dry_ppt,
                                                         extreme_dry_ppt = drier_ppt,
                                                         wetter_ppt = wet_ppt,
                                                         extreme_wet_ppt = wetter_ppt,
...
saveRDS(filtered_climate_data, file = "~/gitRepos/malclimsim/ClimateTutorialDashboard/data/climate_data_province.RDS")
